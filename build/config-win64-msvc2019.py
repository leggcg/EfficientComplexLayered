BUILDDIR        = '#build/release_msvc2019'
DISTDIR         = '#dist/release_msvc2019'
CXX             = 'cl'
CC              = 'cl'
...
# EDIT: msvc2019 bugs Mitsuba when using /O2 because of /Ob2 - replaced it with the full set and /Ob2 for /Ob1
# EDIT: /Og is deprecated too
CXXFLAGS        = ['/nologo', #'/Og',
'/Oi', '/Ot', '/Oy', '/Ob1', #'/Ob2',
'/Gs', '/GF', '/Gy', #'/O2',
'/fp:fast', '/D', 'WIN32', '/D', 'WIN64', '/W3', '/EHsc', '/GS-', '/GL', '/MD', '/D', 'MTS_DEBUG', '/D', 'SINGLE_PRECISION', '/D', 'SPECTRUM_SAMPLES=3', '/D', 'MTS_SSE', '/D', 'MTS_HAS_COHERENT_RT', '/D', '_CONSOLE', '/D', 'NDEBUG', '/D', 'OPENEXR_DLL', '/openmp', '/FC', '/std:c++latest']
SHCXXFLAGS      = CXXFLAGS
TARGET_ARCH     = 'x86_64'
MSVC_VERSION    = '14.2'
LINKFLAGS       = ['/nologo', '/SUBSYSTEM:CONSOLE', '/MACHINE:X64', '/FIXED:NO', '/OPT:REF', '/OPT:ICF', '/LTCG', '/NODEFAULTLIB:LIBCMT', '/MANIFEST', '/DEBUG:FASTLINK']
...
BOOSTLIB        = ['boost_system-vc141-mt-x64-1_69', 'boost_filesystem-vc141-mt-x64-1_69', 'boost_thread-vc141-mt-x64-1_69']
...
LIBSUFFIX       = '.lib'
PROGSUFFIX      = '.exe'
PYTHON27LIB     = ['boost_python27-vc141-mt-x64-1_69', 'python27']
PYTHON27INCLUDE = ['#dependencies/include/python27']
PYTHON36LIB     = ['boost_python36-vc141-mt-x64-1_69', 'python36']
PYTHON36INCLUDE = ['#dependencies/include/python36']
PYTHON37LIB     = ['boost_python37-vc141-mt-x64-1_69', 'python37']
PYTHON37INCLUDE = ['#dependencies/include/python37']
