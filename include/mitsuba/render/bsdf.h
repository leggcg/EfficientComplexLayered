...
public:
    ...
    // For Guo2018
    virtual Spectrum evalguo2018(const BSDFSamplingRecord &bRec, Float &pdf,
                          EMeasure measure = ESolidAngle) const;
    virtual void evalAndSample(BSDFSamplingRecord &bRec, Spectrum &evalVal, 
                          Float &evalPdf, Spectrum &sampleVal, Float &samplePdf,
			  const Point2 &nextSample, EMeasure measure = ESolidAngle) const;
