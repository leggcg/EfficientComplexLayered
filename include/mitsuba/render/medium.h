...
public:
    ...
    // For Guo2018
    virtual void setSigmaAST(const Spectrum &sigmaT, const Spectrum &albedo);
    virtual void setMediumProp(const Float &density, const Spectrum &albedo, const Vector &orientation);
