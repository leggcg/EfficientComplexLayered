...
class DirectIntegratorLightOnly : public SamplingIntegrator {
public:
	DirectIntegratorLightOnly(const Properties &props) : SamplingIntegrator(props) {
	...
	DirectIntegratorLightOnly(Stream *stream, InstanceManager *manager)
	...
	std::string toString() const {
		...
		oss << "DirectIntegratorLightOnly[" << endl
...
MTS_IMPLEMENT_CLASS_S(DirectIntegratorLightOnly, false, SamplingIntegrator)
MTS_EXPORT_PLUGIN(DirectIntegratorLightOnly, "Direct illumination integrator, light sampling only");
MTS_NAMESPACE_END
